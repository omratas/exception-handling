...
import com.exceptionhandling.exceptionhandling.enums.ValidationError;
import com.exceptionhandling.exceptionhandling.exceptions.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleConstraintViolation(
        ...
        apiError.setMessage(ValidationError.CONSTRAINT_VIOLATION.getDescription());
        apiError.setCode(ValidationError.CONSTRAINT_VIOLATION.getCode());
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
            ...
            WebRequest request) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        apiError.setMessage(ValidationError.METHOD_ARGUMENT_NOT_VALID.getDescription());
        apiError.setCode(ValidationError.METHOD_ARGUMENT_NOT_VALID.getCode());
